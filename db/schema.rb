...
ActiveRecord::Schema.define(version: 20150920083737) do
  ...
  add_index "enrolleds", ["email"], name: "index_enrolleds_on_email", unique: true, using: :btree
  add_index "enrolleds", ["reset_password_token"], name: "index_enrolleds_on_reset_password_token", unique: true, using: :btree
